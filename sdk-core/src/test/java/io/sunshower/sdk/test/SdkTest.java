...
public abstract class SdkTest extends SerializationTestCase {
  ...
  public SdkTest() {
    this(SerializationAware.Format.JSON, new Class[] {PersistentElement.class});
  }
  ...
  protected static synchronized void changeSession(String userId, String unencryptedPassword) {
